...
BURIQ() {
  curl -sS https://raw.githubusercontent.com/KhaiVpn767/encrypt/main/allow >/root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/KhaiVpn767/encrypt/main/allow | grep $MYIP | awk '{print $2}')
...
PERMISSION() {
  MYIP=$(curl -sS ipv4.icanhazip.com)
  IZIN=$(curl -sS https://raw.githubusercontent.com/KhaiVpn767/encrypt/main/allow | awk '{print $4}' | grep $MYIP)
  if [ "$MYIP" = "$IZIN" ]; then
    Bloman
  else
...
MYIP=$(curl -sS ipv4.icanhazip.com)
client=$(curl -sS https://raw.githubusercontent.com/KhaiVpn767/encrypt/main/allow | grep $MYIP | awk '{print $2}')
exp=$(curl -sS https://raw.githubusercontent.com/KhaiVpn767/encrypt/main/allow | grep $MYIP | awk '{print $3}')
yell='\e[1;33m'
NC='\e[0m'
